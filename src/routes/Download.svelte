...
{#if stateVisible}
	<div class="fixed right-12 bottom-10 z-50 w-auto">
		<div
			class="flex justify-between border border-transparent bg-slate-800 p-3 text-sm text-slate-50 shadow-lg md:rounded-sm dark:border-slate-700"
		>
			<div class="inline-flex space-x-1 text-slate-500">
			...
			<button
				...
				class="ml-3 cursor-pointer border-l border-gray-700 pl-2 text-slate-500 hover:text-slate-400"
			>
