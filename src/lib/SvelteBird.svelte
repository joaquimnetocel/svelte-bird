			...
			<div class="relative flex flex-1 flex-col overflow-x-hidden overflow-y-hidden">
				...
				>
					<div class="flex px-4 sm:px-6 lg:px-8">
						<MobileMenuButton />
						<div class="-mb-px flex h-16 grow items-center justify-between">
				...
				<footer
					class="sticky z-30 border-t border-slate-400 bg-white px-2 sm:px-4 lg:px-4 dark:border-slate-700 dark:bg-[#182235]"
				>
