<script lang="ts">
	...
	export let propHref: string | undefined;
</script>

<a aria-current="page" class="flex items-center space-x-2" href={propHref || '/'}>
	<img src={propLogo ?? imageLogo} alt="Logo" width={propWidth ?? 30} />
	<slot>
		<span
